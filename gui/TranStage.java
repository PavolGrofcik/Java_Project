...
public class TranStage extends Stage {
	...
	private Label header = new Label("Zadajte öpecifik·cie");
	...
	private Button add = new Button("Pridaj");
	...
	public TranStage(Objedn·vka objedn·vka){
		...
		add.setOnAction(e->{
			...
			/*	
				...
				alert.setTitle("Chyba");
				alert.setHeaderText("Error");
				alert.setContentText("Nevyplnili ste niektorÈ polia");									//Alert pre NumberFormatException
				alert.show();
			}
		});
